...
{\blfootnote{Sur ce graphique, on voit le temps d'exécution de mon programme sur le fichier test \texttt{tree.txt} selon le nombre de filtrage appliqué, en comparaison avec le programme \texttt{demo}.}}
