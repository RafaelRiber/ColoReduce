...
\SetKwIF{Si}{SinonSi}{Sinon}{Si}{}{Sinon si}{}{fin}
...
\begin{algorithm}[H]
\SetSideCommentLeft
    \KwIn{Image normalisée N, de taille $C \times L$, nombre de filtres à appliquer $f$, nombre de couleurs réduites $r$ de l'image}
